...
config = '/groups/tensorlab/rgundaka/code/PINO/rishi/configs/Darcy/test/Darcy-finetune-normal-op-sa.yaml'

out_dir = '/groups/tensorlab/rgundaka/code/PINO/rishi/configs/Darcy/test/'
